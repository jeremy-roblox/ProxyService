...
const USE_OVERIDE_STATUS = process.env.USE_OVERIDE_STATUS === 'true'
...
assert.ok(ALLOWED_GZIP_METHODS(GZIP_METHOD), `GZIP_METHOD must be one of the following values: ${JSON.stringify(ALLOWED_GZIP_METHODS)}`)
